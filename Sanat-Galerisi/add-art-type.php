...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
echo "<script>alert('Sanat Türü Eklendi.');</script>";
...
<head>
  <title>Sanat Türü Ekle | Sanat Galerisi Yönetim Sistemi</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Sanat Türü Ekle</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Anasayfa</a></li>
              <li><i class="icon_document_alt"></i>Sanat Türü</li>
              <li><i class="fa fa-file-text-o"></i>Sanat Türü Ekle</li>
            </ol>
          </div>
        </div>
        <div class="row">
