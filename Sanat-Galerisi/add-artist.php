...
{
echo "<script>alert('Geçersiz format. Yalnızca jpg / jpeg/ png /gif formatına izin verilir');</script>";
}
else
{
...
$proimg=md5($img).$extension;
    ...
    if ($query) {
echo "<script>alert('Sanatçı ayrıntıları eklendi.');</script>";
...
<head>
  <title>Sanatçı Ekle | Sanat Galerisi Yönetim Sistemi</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Sanatçı Ayrıntısı Ekle</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="icon_document_alt"></i>Sanatçı</li>
              <li><i class="fa fa-file-text-o"></i>Sanatçı Ayrıntısı Ekle</li>
            </ol>
          </div>
        </div>
        <div class="row">
