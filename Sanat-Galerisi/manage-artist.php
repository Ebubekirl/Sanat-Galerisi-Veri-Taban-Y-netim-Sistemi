...
if (strlen($_SESSION['agmsaid']) == 0) {
    ...
    <head>
        ...
        <title>Sanatçıları Yönet | Sanat Galerisi Yönetim Sistemi</title>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-table"></i> Sanatçıları Yönet</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="dashboard.php">Ana Sayfa</a></li>
                                <li><i class="fa fa-table"></i>Sanatçı</li>
                                <li><i class="fa fa-th-list"></i>Sanatçıları Yönet</li>
                            </ol>
                        </div>
                    </div>
                    <!-- Sayfa başlangıcı -->
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit-artist-detail.php?editid=<?php echo $row['ID']; ?>"
                                                    class="btn btn-success">Düzenle</a> || <a
                                                    href="manage-artist.php?delid=<?php echo $row['ID']; ?>"
