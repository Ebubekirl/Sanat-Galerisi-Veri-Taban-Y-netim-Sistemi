...
//$pic4=md5($pic4).time().$extension4;
    ...
    if ($query) {
echo "<script>alert('Sanat ürünü ayrıntıları gönderildi.');</script>";
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content" style="color:#000">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Sanat Ürün Detayı</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Anasayfa</a></li>
              <li><i class="icon_document_alt"></i>Sanat Ürünü</li>
              <li><i class="fa fa-file-text-o"></i>Sanat Ürün Detayı</li>
            </ol>
          </div>
        </div>
        <div class="row">      
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Baslık</label>
                    <div class="col-sm-10">
                      <input class="form-control" id="title" name="title"  type="text" required="true" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Özellikli resim</label>
                    <div class="col-sm-10">
    ...
    <div class="form-group">
                    <label class="col-sm-2 control-label">Sanat Ürünü Görseli 1</label>
                    <div class="col-sm-10">
  ...
  <div class="form-group">
                    <label class="col-sm-2 control-label">Sanat Ürünü Görseli 2</label>
                    <div class="col-sm-10">
                    ...
                    <div class="form-group">
                    <label class="col-sm-2 control-label">Sanat Ürünü Görseli 3</label>
                    <div class="col-sm-10">
                    ...
                    <div class="form-group">
                    <label class="col-sm-2 control-label">Sanat Ürünü Görseli 4</label>
                    <div class="col-sm-10">
...
<div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Oryantasyon</label>
                    <div class="col-sm-10">
                      <select class="form-control" id="orientation" name="orientation"  required="true">
                        <option value="">Yönü seçin</option>
                        <option value="Potrait">Vesika</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" id="size" name="size"  required="true">
                        <option value="">Boyutu Seçin</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="arttype" id="arttype">
                                <option value="">Sanat Türünü Seçin</option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control m-bot15" name="artmed" id="artmed">
                                <option value="">Sanat Ortamını Seçin</option>
              ...
              <option value="<?php echo $row['ID'];?>"><?php echo $row['ArtMedium'];?></option>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Sanat Ürün Açıklaması</label>
                    <div class="col-sm-10">
