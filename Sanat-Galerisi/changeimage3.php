...
if (strlen($_SESSION['agmsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        $sanat_urun_id = $_GET['editid'];
        $sanat_resmi_ad = $_FILES["images"]["name"];
        $uzanti = substr($sanat_resmi_ad, strlen($sanat_resmi_ad) - 4, strlen($sanat_resmi_ad));
        ...
        if (!in_array($uzanti, $izinli_uzantilar)) {
            ...
            $sanat_resmi_adi = md5($sanat_resmi_ad) . $uzanti;
            move_uploaded_file($_FILES["images"]["tmp_name"], "images/" . $sanat_resmi_adi);

            $sorgu = mysqli_query($con, "UPDATE tblartproduct SET Image2 ='$sanat_resmi_adi' WHERE ID='$sanat_urun_id'");
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="">
                                    ...
                                    <?php
                                    $sanat_urun_id = $_GET['editid'];
                                    $sorgu = mysqli_query($con, "SELECT * FROM tblartproduct WHERE ID='$sanat_urun_id'");
                                    $cnt = 1;
